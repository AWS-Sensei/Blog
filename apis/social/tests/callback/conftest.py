...
_path = os.path.join(os.path.dirname(__file__), "..", "..", "src", "callback", "handler.py")
_spec = importlib.util.spec_from_file_location("social_callback_handler", _path)
_handler = importlib.util.module_from_spec(_spec)
sys.modules["social_callback_handler"] = _handler
